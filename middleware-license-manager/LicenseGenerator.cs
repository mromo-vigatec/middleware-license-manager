...
namespace middleware_license_manager
{
    public static class LicenseGenerator
    {
        ...
        /// </summary>
        /// <param name="numeroSerial">Número serial del sistema</param>
        /// <param name="machineID">Machine ID del sistema Linux (/etc/machine-id)</param>
        /// <param name="serialDisco">Serial del disco (lsblk -no SERIAL)</param>
            ...
            X509Certificate2 certificado = null)
        {
            try
            {
                ...
                licenseContent.AppendLine("[SYSTEM_INFO]");
                licenseContent.AppendLine($"MachineIDSource=/etc/machine-id");
                licenseContent.AppendLine($"DiskSerialCommand=lsblk -no SERIAL /dev/nvme0n1");
                licenseContent.AppendLine($"SystemType=Linux");
                licenseContent.AppendLine();
                ...
                string dataToHash = $"{numeroSerial}|{machineID}|{serialDisco}|{fechaExpiracion:yyyy-MM-dd}";
                ...
                licenseContent.AppendLine($"HashAlgorithm=SHA256");
                licenseContent.AppendLine($"DataFormat=SerialNumber|MachineID|DiskSerial|ExpirationDate");
                ...
                if (certificado != null && certificado.HasPrivateKey)
                {
                    ...
                    licenseContent.AppendLine($"SignatureAlgorithm=RSA-SHA256");
                }
                ...
                licenseContent.AppendLine("# Designed for Linux systems using machine-id and disk serial");
                licenseContent.AppendLine("# Do not modify this file as it may invalidate the license");
                licenseContent.AppendLine($"# Generated on: {DateTime.Now:yyyy-MM-dd HH:mm:ss}");
